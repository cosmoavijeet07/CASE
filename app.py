...
st.set_page_config(page_title="Chat with CASE", layout="wide", )
st.title("Chat with CASE!!")
...
st.sidebar.markdown("## **Welcome to CASE the Document Q & A Chatbot**")
st.sidebar.markdown('##### This chatbot is specifically build for IIT Ropar, Minor in AI Course as part of Q & A Chatbot')
...
if "intro_displayed" not in st.session_state:
    ...
    intro = "Hello, I am CASE, a  Document Q & A Bot"
    intro2= "Chat with CASE"
...
prompt = st.chat_input("Chat with CASE..")
